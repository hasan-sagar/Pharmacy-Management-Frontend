...
import { useGetSingleProduct } from "@/api/ProductApi";
...
export function PurchaseEditForm({ onSave }: Props) {
  const { purchaseId } = useParams<{ purchaseId: string }>();
  //single purchase hook
  const { productData, isLoading: isSingleProductLoading } =
    useGetSingleProduct(purchaseId as string);
  ...
  useEffect(() => {
    if (productData) {
      form.reset({
        ...
        buyPrice: productData.buyPrice.toString(),
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input type="number" id="buyPrice" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input type="number" id="sellPrice" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input type="number" id="quantity" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
