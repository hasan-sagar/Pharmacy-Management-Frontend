import { useSearchAndGetProductsExpired } from "@/api/ProductApi";
import ProductStockInfo from "@/components/main/products/ProductStockInfo";
...
export default function ProductExpirePage() {
  //search table
  ...
  const { productsData, isLoading } =
    useSearchAndGetProductsExpired(searchState);
  ...
  return (
    <main className="flex flex-col gap-4 p-4 lg:gap-6 lg:p-6">
      ...
      <div className="flex flex-col gap-5">
        ...
        />
        <ProductStockInfo isLoading={isLoading} productsData={productsData} />
        <PurchasePaginator
